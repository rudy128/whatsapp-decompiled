...
public final class C164198Xx extends C23577Bm6 implements C22356B4k {
    public static final C164198Xx DEFAULT_INSTANCE;
    public static final int IS_SENT_FIELD_NUMBER = 1;
    public static volatile C22357B4l PARSER;
    public int bitField0_;
    public boolean isSent_;

    /* JADX WARNING: type inference failed for: r1v0, types: [X.Bm6, X.8Xx] */
    static {
        ? bm6 = new C23577Bm6();
        DEFAULT_INSTANCE = bm6;
        C23577Bm6.A0E(bm6, C164198Xx.class);
    }
