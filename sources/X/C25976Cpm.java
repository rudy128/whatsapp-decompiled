...
public final class C25976Cpm {
    public static C25976Cpm A01;
    ...
    public static final boolean A00(PackageInfo packageInfo, boolean z) {
        ...
        byte[][] bArr = z ? new byte[][]{A02, A03} : new byte[][]{A02};
    ...
    public final boolean A01() {
        ...
        try {
            packageInfo = C41401wK.A00(this.A00).A00.getPackageManager().getPackageInfo("com.google.android.wearable.app.cn", 64);
        ...
        if (GooglePlayServicesUtil.A02(this.A00)) {
    ...
    public C25976Cpm(Context context) {
