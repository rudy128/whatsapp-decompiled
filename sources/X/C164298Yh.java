...
public final class C164298Yh extends C23577Bm6 implements C22356B4k {
    public static final C164298Yh DEFAULT_INSTANCE;
    public static final int ENCRYPTED_PAYLOAD_FIELD_NUMBER = 1;
    public static final int IV_FIELD_NUMBER = 2;
    public static volatile C22357B4l PARSER;
    public int bitField0_;
    public DSQ encryptedPayload_;
    public DSQ iv_;

    static {
        C164298Yh r1 = new C164298Yh();
        DEFAULT_INSTANCE = r1;
        C23577Bm6.A0E(r1, C164298Yh.class);
    }

    public C164298Yh() {
        DSQ dsq = DSQ.A00;
        this.encryptedPayload_ = dsq;
        this.iv_ = dsq;
    }
