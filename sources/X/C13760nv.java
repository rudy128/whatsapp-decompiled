...
public final class C13760nv extends AnonymousClass11G implements AnonymousClass1OS {
    ...
    public C13760nv(C17090tj r2, C27069DRu dRu, C26251Cvq cvq, Map map, C22821Di r6, int i, int i2, int i3, int i4, int i5, boolean z) {
        super(2);
        this.$text = dRu;
        this.$modifier = r2;
        this.$style = cvq;
    ...
    public final void A00(C17130tn r13) {
        ...
        C17130tn r0 = r13;
        AnonymousClass0PY.A02(r0, r1, dRu, cvq, this.$inlineContent, r5, i, this.$maxLines, this.$minLines, AnonymousClass0L8.A00(this.$$changed), this.$$default, z);
    }
