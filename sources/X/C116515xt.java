...
public class C116515xt extends C121926Ma {
    public /* bridge */ /* synthetic */ Object A0G(Object[] objArr) {
        ...
        if (!r3.isCancelled()) {
            ...
            while (it.hasNext()) {
                ...
                if (!A12.contains(A0g) && A0O2.A0H != null && !A0O2.A0F() && this.A02.A0l(A0O2, this.A06) && !this.A0B.contains(A0g) && !C22971Dz.A0Z(A0g) && !C22971Dz.A0a(A0g) && A0Q(A0O2, A0O)) {
                    A133.add(A0O2);
            ...
            if (!r3.isCancelled()) {
                Collections.sort(A133, new C146987Rj(this.A02, this.A03));
                A0L(A13, A132, 2131893619, false);
                if (!r3.isCancelled()) {
