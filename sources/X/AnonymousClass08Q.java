...
public final class AnonymousClass08Q<K, V> extends C07000aC<K, V, V> {
    public boolean containsAll(Collection collection) {
        if (collection == null || !collection.isEmpty()) {
            for (Object containsValue : collection) {
                if (!A00().containsValue(containsValue)) {
                    return false;
                }
            }
        }
    ...
    public /* bridge */ /* synthetic */ Iterator iterator() {
        C06960a8 A00 = A00();
        return new AnonymousClass08U(A00, AnonymousClass000.A15(A00.A01().A02()));
    }
    ...
    public AnonymousClass08Q(C06960a8 r1) {
        super(r1);
    }
}
