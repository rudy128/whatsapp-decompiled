...
public abstract class AnonymousClass04Q extends Drawable.ConstantState {
    public int A00;
    public int A01;
    public int A02;
    public int A03;
    ...
    public Drawable[] A0X;
    public final AnonymousClass04V A0Y;
    ...
    private Drawable A00(Drawable drawable) {
        if (Build.VERSION.SDK_INT >= 23) {
            C27831Xu.A0G(this.A09, drawable);
        }
    ...
    public static void A01(AnonymousClass04Q r6) {
        SparseArray sparseArray = r6.A0H;
        if (sparseArray != null) {
            int size = sparseArray.size();
            for (int i = 0; i < size; i++) {
                r6.A0X[r6.A0H.keyAt(i)] = r6.A00(((Drawable.ConstantState) r6.A0H.valueAt(i)).newDrawable(r6.A0D));
            }
            r6.A0H = null;
        }
    }
    ...
    public final Drawable A03(int i) {
        ...
        Drawable A002 = A00(((Drawable.ConstantState) this.A0H.valueAt(indexOfKey)).newDrawable(this.A0D));
        this.A0X[i] = A002;
    ...
    public final void A07(Resources.Theme theme) {
        if (theme != null) {
            A01(this);
            int i = this.A0A;
            Drawable[] drawableArr = this.A0X;
            for (int i2 = 0; i2 < i; i2++) {
                Drawable drawable = drawableArr[i2];
                if (drawable != null && C27831Xu.A0H(drawable)) {
                    C27831Xu.A05(theme, drawableArr[i2]);
                    this.A01 |= drawableArr[i2].getChangingConfigurations();
                }
            }
            A08(theme.getResources());
        }
    }

    public final void A08(Resources resources) {
        if (resources != null) {
            this.A0D = resources;
    ...
    public final boolean A09(int i, int i2) {
        ...
        for (int i4 = 0; i4 < i3; i4++) {
            if (drawableArr[i4] != null) {
                if (Build.VERSION.SDK_INT >= 23) {
                    z = C27831Xu.A0G(i, drawableArr[i4]);
                } else {
                    z = false;
                }
                if (i4 == i2) {
    ...
    public boolean canApplyTheme() {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            Drawable drawable = drawableArr[i2];
            if (drawable != null) {
                canApplyTheme = C27831Xu.A0H(drawable);
            } else {
    ...
    public AnonymousClass04Q(Resources resources, AnonymousClass04Q r7, AnonymousClass04V r8) {
