...
public class C109785e0 extends OrientationEventListener {
    public int A00 = -1;
    public final Handler A01 = new Handler(Looper.getMainLooper(), new AnonymousClass75Y(this, 1));
    ...
    public void onOrientationChanged(int r7) {
        ...
        L_0x005f:
            ...
            goto L_0x001b
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C109785e0.onOrientationChanged(int):void");
    }

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C109785e0(Context context, OrientationViewModel orientationViewModel) {
        super(context);
