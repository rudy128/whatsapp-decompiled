...
public final class C135776sk {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C135776sk) {
                C135776sk r5 = (C135776sk) obj;
    ...
    public C135776sk(Integer num, PublicKey publicKey, X509Certificate x509Certificate, X509Certificate x509Certificate2) {
    ...
    public String toString() {
        ...
        A10.append("SupportCertificate(encryptionCertificate=");
        A10.append(this.A02);
