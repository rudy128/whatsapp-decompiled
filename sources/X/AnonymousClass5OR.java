...
public final class AnonymousClass5OR extends AnonymousClass11G implements C18090vk {
    public final /* synthetic */ String $key = "arg_jid";
    public final /* synthetic */ Activity $this_jidArg;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AnonymousClass5OR(Activity activity) {
        super(0);
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        ...
        if (!(intent2 == null || (stringExtra = intent2.getStringExtra(this.$key)) == null)) {
            ...
            if ((A0n instanceof C29681ch) && A0n != null) {
                return A0n;
            }
        }
        throw C99684tI.A00;
