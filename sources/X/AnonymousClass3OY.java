...
public class AnonymousClass3OY extends Animation {
    public int A00;
    public Camera A01;
    public ImageView A02;
    public boolean A03;

    public AnonymousClass3OY(ImageView imageView, int i) {
        this.A02 = imageView;
        this.A00 = i;
    }
    ...
    public void applyTransformation(float f, Transformation transformation) {
        ...
        matrix.postTranslate((float) (imageView.getWidth() / 2), (float) (imageView.getHeight() / 2));
        if (i > 90 && !this.A03) {
            this.A03 = true;
