...
public final class AnonymousClass8I2 extends C40611uz {
    public void A05(Rect rect, View view, C38021qZ r7, RecyclerView recyclerView) {
        ...
        if (recyclerView.A0B != null && A00 == 0) {
            view.setPaddingRelative(view.getPaddingStart(), AnonymousClass3MW.A01(view.getResources(), 2131168341), view.getPaddingEnd(), view.getPaddingBottom());
        }
    }
}
