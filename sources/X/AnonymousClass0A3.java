...
public final class AnonymousClass0A3 extends AnonymousClass0HR {
    ...
    public AnonymousClass0A3(float f, float f2, float f3, float f4, float f5, float f6) {
        super(true, false);
        this.A00 = f;
        this.A03 = f2;
        this.A01 = f3;
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof AnonymousClass0A3) {
