...
public class C26286Cwi {
    ...
    public C26286Cwi(int i, float f) {
        init(3, 1.0f);
    }
    ...
    public void init(int i, float f) {
        int closedTableSize = AnonymousClass111.closedTableSize(3, 1.0d);
    ...
    public C25259Cby getEntry(int i) {
        C199610h.A01(i, this.size);
        return new C23557Bll(this, i);
    }
    ...
    public int put(Object obj, int i) {
        C201310y.checkPositive(i, "count");
        long[] jArr = this.entries;
        ...
        if (i3 == -1) {
            ...
            while (true) {
                long j = jArr[i3];
                if (getHash(j) != smearedHash || !C24604CBi.A00(obj, objArr[i3])) {
                    int next = getNext(j);
                    if (next == -1) {
        ...
        throw AnonymousClass000.A0n("Cannot contain more than Integer.MAX_VALUE elements!");
    }
    ...
    private int remove(Object obj, int i) {
        ...
        if (i2 != -1) {
            int i3 = -1;
            while (true) {
                if (getHash(this.entries[i2]) != i || !C24604CBi.A00(obj, this.keys[i2])) {
    ...
    public int indexOf(Object obj) {
        ...
        while (i != -1) {
            ...
            if (getHash(j) == smearedHash && C24604CBi.A00(obj, this.keys[i])) {
                return i;
            }
            i = getNext(j);
        }
