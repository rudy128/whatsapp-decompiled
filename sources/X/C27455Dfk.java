...
public final class C27455Dfk extends AnonymousClass11G implements C18090vk {
    public final /* synthetic */ C26595D5j this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C27455Dfk(C26595D5j d5j) {
        super(0);
        this.this$0 = d5j;
    }
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        ...
        if (list.isEmpty()) {
            ...
            float BUS = ((C25182CaY) A0p).A02.BUS();
            int A01 = AnonymousClass3MX.A01(list);
            int i = 1;
            if (1 <= A01) {
                while (true) {
                    Object obj = list.get(i);
                    float BUS2 = ((C25182CaY) obj).A02.BUS();
                    if (Float.compare(BUS, BUS2) < 0) {
                        A0p = obj;
                        BUS = BUS2;
                    }
                    if (i == A01) {
