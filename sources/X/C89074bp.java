...
public final class C89074bp implements Parcelable.Creator {
    public /* bridge */ /* synthetic */ Object createFromParcel(Parcel parcel) {
        ...
        if (parcel.readInt() != 0) {
            ...
            for (int i = 0; i != readInt; i++) {
                arrayList.add(AnonymousClass446.CREATOR.createFromParcel(parcel));
            }
        }
        return new AnonymousClass446(valueOf, valueOf3, valueOf2, valueOf4, r7, readString, readString2, readString3, arrayList);
    }

    public /* bridge */ /* synthetic */ Object[] newArray(int i) {
        return new AnonymousClass446[i];
    }
}
