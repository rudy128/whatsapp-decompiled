...
public final class C06060Wu implements C17500ul {
    ...
    public AnonymousClass0XJ Bjb(long j) {
        ...
        if (num == num2) {
            ...
            return new AnonymousClass0AJ(Bjy, i);
        }
        ...
        return new AnonymousClass0AJ(i, Bjv);
    }
    ...
    public C06060Wu(C16860tL r1, Integer num, Integer num2) {
        this.A00 = r1;
        this.A01 = num;
        this.A02 = num2;
    }
