...
public final class C21193Ag2 implements C22470B9c {
    public static final C21193Ag2 A00 = new C21193Ag2();
    ...
    public final Object BCF(C29621ca r13, C62672rm r14) {
        ...
        String str = (String) r4.A05(r5, String.class, A0i, A0j, "internal-server-error", A1U, false);
        if (str == null) {
            return null;
        }
        Number number = (Number) r4.A05(r5, Long.TYPE, A0i, A0j, AnonymousClass8BV.A0i(), AnonymousClass8BS.A1S(A17), false);
        if (number != null) {
