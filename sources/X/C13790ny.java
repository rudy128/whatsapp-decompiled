...
public final class C13790ny extends AnonymousClass11G implements AnonymousClass1OS {
    ...
    public C13790ny(AnonymousClass0JY r2, C17210uI r3, AnonymousClass0tB r4, AnonymousClass0Ip r5, AnonymousClass0NL r6, C17090tj r7, C16370s9 r8, C18090vk r9, C36001nB r10, int i, int i2, boolean z) {
        super(2);
        this.$onClick = r9;
        this.$modifier = r7;
        this.$enabled = z;
    ...
    public final void A00(C17130tn r15) {
        ...
        C04440Nk.A00(this.$border, this.$interactionSource, this.$contentPadding, r4, r5, r15, r7, r8, r9, this.$content, AnonymousClass0L8.A00(this.$$changed), this.$$default, z);
    }
