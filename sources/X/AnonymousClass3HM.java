...
public final class AnonymousClass3HM extends AnonymousClass11G implements C18090vk {
    public final /* synthetic */ AnonymousClass28H this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public AnonymousClass3HM(AnonymousClass28H r2) {
        super(0);
        this.this$0 = r2;
    }
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        ...
        if (!(copyOnWriteArrayList instanceof Collection) || !copyOnWriteArrayList.isEmpty()) {
            ...
            while (it.hasNext()) {
                if ((it.next() instanceof C41541wb) && (i = i + 1) < 0) {
