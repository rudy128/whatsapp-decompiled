...
public final class C06040Ws implements C17500ul {
    ...
    public AnonymousClass0XJ Bjb(long j) {
        ...
        if (num == num2) {
            ...
            return new AnonymousClass0AH(Bjy, i);
        }
        ...
        return new AnonymousClass0AH(i, Bjv);
    }
    ...
    public C06040Ws(C16860tL r1, Integer num, Integer num2) {
        this.A00 = r1;
        this.A01 = num;
        this.A02 = num2;
    }
