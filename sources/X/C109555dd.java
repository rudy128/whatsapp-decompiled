...
public class C109555dd extends CountDownTimer {
    ...
    public C109555dd(RequestOtpCodeBottomSheetFragment requestOtpCodeBottomSheetFragment, VerifyPhoneNumber verifyPhoneNumber, WDSButton wDSButton, String str, String str2, int i, long j) {
        super(j, 1000);
    ...
    public void onTick(long j) {
        WDSButton wDSButton = this.A03;
        C18000vb r3 = this.A01.A00;
        wDSButton.setText(A9B.A0C(this.A02, r3, this.A04, this.A00, j, true));
    }
}
