...
public final class C11400jy extends AnonymousClass11G implements C22821Di {
    ...
    public C11400jy(C015408x r2, C015408x r3, C22821Di r4, int i) {
        super(1);
    ...
    public final Boolean invoke(C16400sC r5) {
        boolean A02 = AnonymousClass0QK.A01(this.$this_generateAndSearchChildren, this.$focusedItem, this.$onFound, this.$direction);
