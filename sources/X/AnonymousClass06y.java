...
public final class AnonymousClass06y extends AnonymousClass0KZ {
    public int A00;

    public static final int A00(AnonymousClass06y r7, int i) {
        int i2 = r7.A00;
        int i3 = i & i2;
        int i4 = 0;
        while (true) {
    ...
    public static final void A01(AnonymousClass06y r3, int i) {
