...
public class BGJ extends PrintDocumentAdapter {
    public Context A00;
    public PrintedPdfDocument A01;
    public final Bitmap A02;
    public final String A03 = "my_qrcode.pdf";

    public BGJ(Context context, Bitmap bitmap) {
        this.A00 = context;
        this.A02 = bitmap;
    }
    ...
    public void onWrite(PageRange[] pageRangeArr, ParcelFileDescriptor parcelFileDescriptor, CancellationSignal cancellationSignal, PrintDocumentAdapter.WriteResultCallback writeResultCallback) {
        ...
        canvas.drawBitmap(bitmap, (float) ((canvas.getWidth() - bitmap.getWidth()) / 2), (float) ((canvas.getHeight() - bitmap.getHeight()) / 2), (Paint) null);
