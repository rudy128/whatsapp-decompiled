...
public abstract class CID {
    ...
    static {
        ...
        shArr[6] = (short) 19;
        shArr[7] = (short) 20;
        A02 = Collections.unmodifiableSet(C17900vP.A0I((short) 42, shArr, 8));
        Short[] shArr2 = new Short[3];
        shArr2[0] = (short) 51;
        shArr2[1] = (short) 41;
        A04 = Collections.unmodifiableSet(C17900vP.A0I((short) 43, shArr2, 2));
        Short[] shArr3 = new Short[4];
        shArr3[0] = (short) 51;
        shArr3[1] = (short) 41;
        shArr3[2] = (short) 43;
        A03 = Collections.unmodifiableSet(C17900vP.A0I((short) 44, shArr3, 3));
        Short[] shArr4 = new Short[3];
        shArr4[0] = (short) 772;
        shArr4[1] = (short) -1254;
        A01 = Collections.unmodifiableSet(C17900vP.A0I((short) 32540, shArr4, 2));
    }
}
