...
public final class AnonymousClass3BA implements C22486B9s {
    ...
    public boolean BCL(C186309dz r9, C22484B9q b9q, AnonymousClass5YR r11) {
        ...
        int A0N = r1.A0N("privacy_profile_photo");
        long A0W = r1.A0W("privacy_tip_remove_profile_photo_timestamp");
        if (((int) A0W) == -1) {
            return false;
        }
        long j = A0W + millis;
    ...
    public AnonymousClass3BA(AnonymousClass11N r1, C19830z4 r2, C18030ve r3) {
