...
public final class AnonymousClass8ZV extends C23577Bm6 implements C22356B4k {
    public static final int ARCHIVED_FIELD_NUMBER = 1;
    public static final AnonymousClass8ZV DEFAULT_INSTANCE;
    ...
    /* JADX WARNING: type inference failed for: r1v0, types: [X.8ZV, X.Bm6] */
    static {
        ? bm6 = new C23577Bm6();
        DEFAULT_INSTANCE = bm6;
        C23577Bm6.A0E(bm6, AnonymousClass8ZV.class);
    }
    ...
    public final Object A0P(Integer num, Object obj) {
        ...
        switch (num.intValue()) {
            ...
            case 6:
                ...
                synchronized (AnonymousClass8ZV.class) {
                    b4l = PARSER;
                    if (b4l == null) {
