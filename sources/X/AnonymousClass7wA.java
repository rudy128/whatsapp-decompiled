...
public final class AnonymousClass7wA extends AnonymousClass11G implements C18090vk {
    ...
    public AnonymousClass7wA(Fragment fragment, Enum enumR) {
        super(0);
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        ...
        if (!(bundle == null || (string = bundle.getString(this.$key)) == null)) {
            try {
                obj = Enum.valueOf(AnonymousClass6RU.class, string);
            } catch (Throwable th) {
