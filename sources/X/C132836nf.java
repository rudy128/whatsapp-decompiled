...
public final class C132836nf {
    ...
    public final void A00() {
        ...
        if (C108955ca.A0W(this.A03).A09()) {
            ...
            View view = this.A02;
            ((C138876xq) this.A04.get()).A01(new C142847Ba(this, 2), new C142887Be(view, r6, "updates tab search", "updates tab search", this.A01.toString()), new Object());
            try {
    ...
    public C132836nf(View view, C29681ch r3, AnonymousClass00H r4, AnonymousClass00H r5, int i) {
        C18070vi.A0j(r4, r5);
        C18070vi.A0d(r3, 5);
        this.A03 = r4;
        this.A04 = r5;
