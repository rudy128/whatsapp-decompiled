...
public final class AnonymousClass06w extends AnonymousClass0KT {
    public int A00;

    public static final int A00(AnonymousClass06w r7, int i) {
        int i2 = r7.A00;
        int i3 = i & i2;
        int i4 = 0;
        while (true) {
            long A0t = AnonymousClass001.A0t(AnonymousClass002.A01(r7.A03, i3));
            if (A0t != 0) {
    ...
    public AnonymousClass06w() {
        AnonymousClass070 r0 = AnonymousClass0GO.A01;
        A01(this, 6);
    }

    public static final void A01(AnonymousClass06w r3, int i) {
