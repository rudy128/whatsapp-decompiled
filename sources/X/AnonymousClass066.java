...
public class AnonymousClass066 extends AnonymousClass0I5 implements Menu {
    ...
    public void removeGroup(int i) {
        if (this.A00 != null) {
            ...
            while (true) {
                ...
                if (((MenuItem) r1.A04(i2)).getGroupId() == i) {
                    this.A00.A05(i2);
                    i2--;
                }
                i2++;
    ...
    public void removeItem(int i) {
        if (this.A00 != null) {
            ...
            while (true) {
                ...
                if (i2 >= r1.size()) {
                    break;
                } else if (((MenuItem) r1.A04(i2)).getItemId() == i) {
                    this.A00.A05(i2);
                    break;
                } else {
                    i2++;
    ...
    public AnonymousClass066(Context context, AnonymousClass1HG r3) {
        super(context);
        if (r3 != null) {
            this.A00 = r3;
            return;
