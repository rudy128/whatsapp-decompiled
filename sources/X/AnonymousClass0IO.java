...
public class AnonymousClass0IO {
    public static AnonymousClass0IO A03;
    public int A00;
    public long A01;
    public long A02;
    ...
    public void A00(double d, double d2, long j) {
        ...
        double sin2 = d3 + (sin * 0.03341960161924362d) + (Math.sin((double) (2.0f * f2)) * 3.4906598739326E-4d) + (Math.sin((double) (3.0f * f2)) * 5.236000106378924E-6d) + 1.796593063d + 3.141592653589793d;
        double d4 = (-d2) / 360.0d;
