...
public final class AnonymousClass5PN extends AnonymousClass11G implements C18090vk {
    ...
    public AnonymousClass5PN(Fragment fragment, Enum enumR) {
        super(0);
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        ...
        if (!(bundle == null || (string = bundle.getString(this.$key)) == null)) {
            try {
                obj = Enum.valueOf(C82984Cx.class, string);
            } catch (Throwable th) {
