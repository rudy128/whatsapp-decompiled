...
public class C26139Ct2 {
    public static final C002100z A07 = new C002100z(100);
    ...
    public final CZS A06 = new CZS();

    public static StaticLayout A00(Layout.Alignment alignment, TextPaint textPaint, TextUtils.TruncateAt truncateAt, AnonymousClass1X5 r16, CharSequence charSequence, float f, float f2, int i, int i2, int i3, int i4, boolean z) {
    ...
    public static TextDirectionHeuristic A01(AnonymousClass1X5 r1) {
        if (r1 == AnonymousClass1X4.A04) {
            return TextDirectionHeuristics.LTR;
        }
        if (r1 == AnonymousClass1X4.A05) {
            return TextDirectionHeuristics.RTL;
        }
        if (r1 != AnonymousClass1X4.A01) {
            if (r1 == AnonymousClass1X4.A02) {
                return TextDirectionHeuristics.FIRSTSTRONG_RTL;
            }
            if (r1 == AnonymousClass1X4.A00) {
                return TextDirectionHeuristics.ANYRTL_LTR;
            }
            if (r1 == AnonymousClass1X4.A03) {
     ...
     */
    /* JADX WARNING: Code restructure failed: missing block: B:131:0x01ff, code lost:
        continue;
     */
    ...
    /* JADX WARNING: Missing exception handler attribute for start block: B:101:0x0231 */
    /* JADX WARNING: Missing exception handler attribute for start block: B:111:0x028b */
    ...
    public android.text.Layout A02() {
        ...
        L_0x00ee:
            ...
            X.1X5 r0 = r10.A0H     // Catch:{ IndexOutOfBoundsException -> 0x02aa }
            r29 = r0
        ...
        L_0x024e:
            ...
            java.lang.StringBuilder r2 = X.AnonymousClass000.A10()     // Catch:{ IndexOutOfBoundsException -> 0x02aa }
            ...
            java.lang.String r1 = " …"
            java.lang.String r21 = X.AnonymousClass000.A0y(r1, r2)     // Catch:{ IndexOutOfBoundsException -> 0x02aa }
        ...
        L_0x02d6:
            throw r2
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C26139Ct2.A02():android.text.Layout");
    }
