...
public final class AnonymousClass5PW extends AnonymousClass11G implements C18090vk {
    ...
    public AnonymousClass5PW(Fragment fragment, Enum enumR) {
        super(0);
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        ...
        if (!(bundle == null || (string = bundle.getString(this.$key)) == null)) {
            try {
                obj = Enum.valueOf(C83004Cz.class, string);
            } catch (Throwable th) {
