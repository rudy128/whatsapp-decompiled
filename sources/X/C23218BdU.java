...
public abstract class C23218BdU extends C23330BfI {
    public final int A00;

    public final boolean equals(Object obj) {
        if (obj != null && (obj instanceof C28630EBj)) {
            try {
                C23218BdU bdU = (C23218BdU) ((C28630EBj) obj);
                if (bdU.A00 == this.A00) {
                    return Arrays.equals(A01(), (byte[]) new C23228Bde(bdU.A01()).A00);
                }
    ...
    public byte[] A01() {
        byte[] bArr;
        String str;
        if (!(this instanceof C23227Bdd)) {
            return ((C23222BdY) this).A00;
        }
        C23227Bdd bdd = (C23227Bdd) this;
        synchronized (bdd) {
            bArr = (byte[]) bdd.A00.get();
            if (bArr == null) {
                if (bdd instanceof C23226Bdc) {
                ...
                } else if (bdd instanceof C23225Bdb) {
                ...
                } else if (bdd instanceof C23224Bda) {
                ...
                bArr = A00(str);
                bdd.A00 = AnonymousClass3MW.A0z(bArr);
            }
        }
        return bArr;
    }

    public C23218BdU(byte[] bArr) {
        C18210vx.A06(AnonymousClass000.A1T(bArr.length, 25));
