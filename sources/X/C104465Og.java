...
public final class C104465Og extends AnonymousClass11G implements C18090vk {
    ...
    public C104465Og(Fragment fragment) {
        super(0);
    ...
    public final Object invoke() {
        ...
        if (!A09) {
            ...
            if (parcelable instanceof C89254cA) {
                return parcelable;
            }
            return null;
        } else if (bundle == null) {
            ...
            return C24141Ja.A00(bundle, C89254cA.class, this.$key);
        }
    }
}
