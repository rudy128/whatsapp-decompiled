...
public class C28286Dwu extends AnonymousClass1By {
    public int A00;
    public byte[] A01;

    /* JADX WARNING: type inference failed for: r3v0, types: [X.Dwu, java.lang.Object] */
    public static C28286Dwu A01(Object obj) {
        if (obj instanceof C28286Dwu) {
            return (C28286Dwu) obj;
        }
        if (obj == null) {
            return null;
        }
