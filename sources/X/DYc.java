...
public class DYc implements E9Y {
    ...
    public static void A02(String str, byte[] bArr) {
        A03.put(AnonymousClass1Bo.A01(str), bArr);
    }
    ...
    public void BdC(E3O e3o, boolean z) {
        if (e3o instanceof DYg) {
            byte[] bArr = ((DYg) e3o).A00;
            if (bArr.length == A0C.length) {
                this.A01 = AnonymousClass1C2.A02(bArr);
                return;
            }
            throw AnonymousClass000.A0k("invalid S-box passed to GOST28147 init");
            ...
            throw AnonymousClass000.A0k("Key length invalid. Key needs to be 32 byte - 256 bit!!!");
        } else if (e3o != null) {
            throw BEB.A0T(e3o, "invalid parameter passed to GOST28147 init - ", AnonymousClass000.A10());
        }
    }
    ...
    public int CCe(byte[] r12, byte[] r13, int r14, int r15) {
        /*
            r11 = this;
            int[] r5 = r11.A02
        ...
        L_0x005a:
            ...
            int r1 = r15 + 2
            int r0 = r2 >>> 16
            int r1 = X.BE6.A0A(r0, r13, r1, r15)
            int r0 = r2 >>> 8
            byte r0 = (byte) r0
            r13[r1] = r0
            byte r0 = (byte) r2
        ...
        L_0x0092:
            ...
            goto L_0x0054
        L_0x00a5:
            X.DyQ r0 = X.C28380DyQ.A00()
            throw r0
        L_0x00aa:
            X.DyX r0 = X.C28387DyX.A01()
            throw r0
        L_0x00af:
            java.lang.String r0 = "GOST28147 engine not initialised"
            java.lang.IllegalStateException r0 = X.AnonymousClass000.A0n(r0)
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: X.DYc.CCe(byte[], byte[], int, int):int");
    }
}
