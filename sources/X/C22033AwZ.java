...
public final class C22033AwZ extends AnonymousClass11G implements C18090vk {
    ...
    public C22033AwZ(Cw1 cw1, C24337BzY bzY, UUID uuid, C22821Di r5) {
        super(0);
        this.this$0 = cw1;
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        C26294Cx6.A06("lam:LinkedAppManager", "Link switch failed, attempting to establish WiFi link.");
        Cw1 cw1 = this.this$0;
        UUID uuid = this.$serviceUUID;
        C24337BzY bzY = this.$transportType;
        C22821Di r2 = this.$failure;
        Cw1.A03(cw1, bzY, uuid, new C22095AxZ(r2), new C22325B3c(cw1, uuid, r2));
        return C27621Wu.A00;
    }
}
