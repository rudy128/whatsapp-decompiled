...
public final class C164328Yk extends C23577Bm6 implements C22356B4k {
    public static final C164328Yk DEFAULT_INSTANCE;
    public static final int FACT_FIELD_NUMBER = 1;
    public static final int FACT_ID_FIELD_NUMBER = 2;
    public static volatile C22357B4l PARSER;
    public int bitField0_;
    public String factId_ = "";
    public String fact_ = "";

    static {
        C164328Yk r1 = new C164328Yk();
        DEFAULT_INSTANCE = r1;
        C23577Bm6.A0E(r1, C164328Yk.class);
    }
