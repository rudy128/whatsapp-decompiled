...
public final class C135866st {
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof C135866st) {
                C135866st r5 = (C135866st) obj;
    ...
    public C135866st(Integer num, PublicKey publicKey, X509Certificate x509Certificate, X509Certificate x509Certificate2) {
    ...
    public String toString() {
        ...
        A10.append("AvatarCertificate(encryptionCertificate=");
        A10.append(this.A02);
