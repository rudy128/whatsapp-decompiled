...
public final class AnonymousClass0A6 extends AnonymousClass0HR {
    ...
    public AnonymousClass0A6(float f, float f2, float f3, float f4, float f5, boolean z, boolean z2) {
        super(false, false);
        this.A02 = f;
        this.A04 = f2;
        this.A03 = f3;
    ...
    public boolean equals(Object obj) {
        if (this != obj) {
            if (obj instanceof AnonymousClass0A6) {
    ...
    public String toString() {
        ...
        A10.append("RelativeArcTo(horizontalEllipseRadius=");
        A10.append(this.A02);
