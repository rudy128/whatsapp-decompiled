...
public final class C1585681e extends AnonymousClass11G implements C22821Di {
    public final /* synthetic */ C112365lM this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C1585681e(C112365lM r2) {
        super(1);
        this.this$0 = r2;
    }
            ...
            if (observableRecyclerView == null || (layoutManager = observableRecyclerView.getLayoutManager()) == null) {
                ...
                for (int i2 = 0; i2 < A0J; i2++) {
                    ...
                    if (A0P != null) {
                        ...
                        if ((tag instanceof AnonymousClass6JB) && ((AnonymousClass6JB) tag).A07) {
                            arrayList.add(A0P);
