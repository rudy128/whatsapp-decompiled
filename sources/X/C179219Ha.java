...
public class C179219Ha extends InputStream {
    ...
    public int read(byte[] r5, int r6, int r7) {
        ...
        L_0x0022:
            ...
            return r2
        L_0x0039:
            javax.crypto.Cipher r0 = r4.A03     // Catch:{ BadPaddingException | IllegalBlockSizeException -> 0x006c }
            byte[] r1 = r0.doFinal()     // Catch:{ BadPaddingException | IllegalBlockSizeException -> 0x006c }
            r2.put(r1)
            javax.crypto.Mac r0 = r4.A04
        ...
        L_0x007e:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: X.C179219Ha.read(byte[], int, int):int");
    }

    public C179219Ha(C185849dF r5, InputStream inputStream) {
        this.A02 = inputStream;
        byte[] bArr = r5.A01;
        this.A03 = A3N.A01(bArr, r5.A00, 1);
        this.A04 = A3N.A02(bArr, r5.A02);
    }
