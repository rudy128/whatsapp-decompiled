...
public abstract /* synthetic */ class AnonymousClass9TH {
    ...
    static {
        /*
            ...
            int[] r2 = new int[r0]
            A00 = r2
            android.util.JsonToken r0 = android.util.JsonToken.BOOLEAN     // Catch:{ NoSuchFieldError -> 0x0012 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0012 }
            r0 = 1
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0012 }
        L_0x0012:
            android.util.JsonToken r0 = android.util.JsonToken.NULL     // Catch:{ NoSuchFieldError -> 0x001b }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x001b }
            r0 = 2
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x001b }
        L_0x001b:
            android.util.JsonToken r0 = android.util.JsonToken.NUMBER     // Catch:{ NoSuchFieldError -> 0x0024 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0024 }
            r0 = 3
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0024 }
        L_0x0024:
            android.util.JsonToken r0 = android.util.JsonToken.STRING     // Catch:{ NoSuchFieldError -> 0x002d }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x002d }
            r0 = 4
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x002d }
        L_0x002d:
            android.util.JsonToken r0 = android.util.JsonToken.BEGIN_ARRAY     // Catch:{ NoSuchFieldError -> 0x0036 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0036 }
            r0 = 5
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0036 }
        L_0x0036:
            android.util.JsonToken r0 = android.util.JsonToken.BEGIN_OBJECT     // Catch:{ NoSuchFieldError -> 0x003f }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x003f }
            r0 = 6
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x003f }
        L_0x003f:
            android.util.JsonToken r0 = android.util.JsonToken.END_ARRAY     // Catch:{ NoSuchFieldError -> 0x0048 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0048 }
            r0 = 7
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0048 }
        L_0x0048:
            android.util.JsonToken r0 = android.util.JsonToken.END_DOCUMENT     // Catch:{ NoSuchFieldError -> 0x0052 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0052 }
            r0 = 8
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0052 }
        L_0x0052:
            android.util.JsonToken r0 = android.util.JsonToken.END_OBJECT     // Catch:{ NoSuchFieldError -> 0x005c }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x005c }
            r0 = 9
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x005c }
        L_0x005c:
            android.util.JsonToken r0 = android.util.JsonToken.NAME     // Catch:{ NoSuchFieldError -> 0x0066 }
            int r1 = r0.ordinal()     // Catch:{ NoSuchFieldError -> 0x0066 }
            r0 = 10
            r2[r1] = r0     // Catch:{ NoSuchFieldError -> 0x0066 }
        L_0x0066:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: X.AnonymousClass9TH.<clinit>():void");
    }
}
