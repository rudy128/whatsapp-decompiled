...
public final class C164058Xj extends C23577Bm6 implements C22356B4k {
    public static final C164058Xj DEFAULT_INSTANCE;
    public static final int MESSAGEKEY_FIELD_NUMBER = 1;
    public static volatile C22357B4l PARSER;
    public int bitField0_;
    public C166408cq messageKey_;

    /* JADX WARNING: type inference failed for: r1v0, types: [X.8Xj, X.Bm6] */
    static {
        ? bm6 = new C23577Bm6();
        DEFAULT_INSTANCE = bm6;
        C23577Bm6.A0E(bm6, C164058Xj.class);
    }
