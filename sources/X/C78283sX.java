...
public class C78283sX extends AnonymousClass3uP {
    public boolean A00;
    public final TextView A01;
    public final AnonymousClass1GP A02;
    public final AnonymousClass4QD A03;
    ...
    public void A2V(AnonymousClass206 r4, boolean z) {
        ...
        super.A2V(r4, z);
        if (z || A1Z) {
            String string = getContext().getString(2131891570);
            Drawable A0m = AnonymousClass3uQ.A0m(this);
            TextView textView = this.A01;
            AnonymousClass3uQ.A0q(A0m, textView, string);
            C89904dD.A00(textView, this, 31);
        }
    }

    public C1771097h getFMessage() {
        return (C1771097h) this.A0I;
    }

    public void setFMessage(AnonymousClass206 r2) {
        C17960vV.A0D(r2 instanceof C1771097h);
        this.A0I = r2;
    }

    public C78283sX(Context context, AnonymousClass1GP r5, C108875cR r6, AnonymousClass4QD r7, C436420i r8) {
        super(context, r6, r8);
        A1M();
        this.A02 = r5;
        this.A03 = r7;
