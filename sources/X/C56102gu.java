...
public class C56102gu {
    ...
    public C56102gu(GroupJid groupJid, CallLogInfo callLogInfo, String str, String str2, List list, int i, int i2, boolean z, boolean z2, boolean z3) {
        this.A01 = i;
        this.A04 = str;
        this.A00 = i2;
        this.A06 = list;
