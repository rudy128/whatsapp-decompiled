...
public final class C06670Zf implements Comparator {
    public static final C06670Zf A00 = new Object();

    public /* bridge */ /* synthetic */ int compare(Object obj, Object obj2) {
        AnonymousClass0NU A0D = ((C05060Qg) obj).A0D();
        AnonymousClass0NU A0D2 = ((C05060Qg) obj2).A0D();
        int compare = Float.compare(A0D.A01, A0D2.A01);
        if (compare != 0) {
            return compare;
        }
        ...
        if (compare3 == 0) {
            return Float.compare(A0D.A02, A0D2.A02);
        }
        return compare3;
    }
}
