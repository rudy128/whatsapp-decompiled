...
public final class C164188Xw extends C23577Bm6 implements C22356B4k {
    public static final int ALLOWED_FIELD_NUMBER = 1;
    public static final C164188Xw DEFAULT_INSTANCE;
    public static volatile C22357B4l PARSER;
    public boolean allowed_;
    public int bitField0_;

    /* JADX WARNING: type inference failed for: r1v0, types: [X.Bm6, X.8Xw] */
    static {
        ? bm6 = new C23577Bm6();
        DEFAULT_INSTANCE = bm6;
        C23577Bm6.A0E(bm6, C164188Xw.class);
    }
