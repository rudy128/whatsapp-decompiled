...
public final class C27826DmN extends AnonymousClass11G implements C18090vk {
    public final /* synthetic */ View $itemView;
    public final /* synthetic */ Bq2 this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public C27826DmN(View view, Bq2 bq2) {
        super(0);
        this.this$0 = bq2;
        this.$itemView = view;
    }
    ...
    public /* bridge */ /* synthetic */ Object invoke() {
        ...
        if (z) {
            ...
            if (ckZ != null) {
                view = wDSListItem.findViewById(2131436861);
                if (view instanceof ViewStub) {
                    ...
                    Log.w("inflateCallVoiceButtonWidget : can't find the ViewStub in the hierarchy, maybe the function is called multiple times, call it once to improve the performances");
                }
            } else {
                view = null;
            }
            ...
            if (bq22.A09 != null) {
                C89874dA.A00(view, bq22, 28);
            }
            return view;
        }
        View A06 = AnonymousClass1HF.A06(view2, 2131436861);
        C18070vi.A0b(A06);
        return A06;
    }
}
