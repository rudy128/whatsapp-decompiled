...
public final class AnonymousClass0X5 implements C16870tM {
    public static final AnonymousClass0X5 A00 = new AnonymousClass0X5();
    ...
    public final C16820tH BjZ(C17530uo r5, List list, long j) {
        ArrayList A14 = AnonymousClass000.A14(list);
        int size = list.size();
        for (int i = 0; i < size; i++) {
            AnonymousClass001.A1T(A14, list, i, j);
        }
        return r5.BhL(AnonymousClass1D7.A0I(), new C09650h4(A14), Constraints.A01(j), Constraints.A00(j));
    }
}
