...
public abstract class Hilt_BusinessDirectoryPopularApiBusinessesFragment extends Fragment implements AnonymousClass009 {
    ...
    public void A1p(android.app.Activity r4) {
        ...
        L_0x000f:
            ...
            X.8HW r0 = X.C36241nZ.A0f(r0)
            r1.A01 = r0
        L_0x002c:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.businessdirectory.view.fragment.Hilt_BusinessDirectoryPopularApiBusinessesFragment.A1p(android.app.Activity):void");
    }
    ...
    public void A1x(Context context) {
        ...
        if (!this.A00) {
            this.A00 = true;
            ((BusinessDirectoryPopularApiBusinessesFragment) this).A01 = C36241nZ.A0f((C36241nZ) ((C008903z) generatedComponent()));
        }
    }
