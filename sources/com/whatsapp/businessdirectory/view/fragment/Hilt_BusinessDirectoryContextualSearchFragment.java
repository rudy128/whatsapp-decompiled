...
public abstract class Hilt_BusinessDirectoryContextualSearchFragment extends Fragment implements AnonymousClass009 {
    ...
    public void A1p(android.app.Activity r4) {
        ...
        L_0x000f:
            ...
            X.C36241nZ.A1f(r1, r0)
        L_0x0029:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.businessdirectory.view.fragment.Hilt_BusinessDirectoryContextualSearchFragment.A1p(android.app.Activity):void");
    }
    ...
    public void A1x(Context context) {
        ...
        if (!this.A00) {
            this.A00 = true;
            C36241nZ.A1f((C36241nZ) ((C008903z) generatedComponent()), (BusinessDirectoryContextualSearchFragment) this);
        }
    }
