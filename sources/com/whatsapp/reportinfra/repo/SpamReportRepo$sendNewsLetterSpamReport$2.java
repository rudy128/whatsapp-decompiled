...
@DebugMetadata(c = "com.whatsapp.reportinfra.repo.SpamReportRepo$sendNewsLetterSpamReport$2", f = "SpamReportRepo.kt", i = {}, l = {155}, m = "invokeSuspend", n = {}, s = {})
public final class SpamReportRepo$sendNewsLetterSpamReport$2 extends C30431dv implements AnonymousClass1OS {
    ...
    public SpamReportRepo$sendNewsLetterSpamReport$2(C29681ch r2, SpamReportRepo spamReportRepo, String str, C30391dr r5) {
        super(2, r5);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            C29681ch r3 = this.$newsletterJid;
            String str = this.$reportOrigin;
            this.label = 1;
            String A0T = C17890vO.A0T(spamReportXmppClient.A03);
            obj = SpamReportXmppClient.A00(((C190309kj) spamReportXmppClient.A04.get()).A00(r3, A0T, str, (List) this.L$0), spamReportXmppClient, A0T, this, 98);
            if (obj == r6) {
                return r6;
            }
        } else if (i == 1) {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return ((SpamReportRepo$sendNewsLetterSpamReport$2) C30411dt.A04(obj2, obj, this)).invokeSuspend(C27621Wu.A00);
    }
}
