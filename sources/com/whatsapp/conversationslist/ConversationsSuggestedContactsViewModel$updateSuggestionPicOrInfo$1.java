...
public final class ConversationsSuggestedContactsViewModel$updateSuggestionPicOrInfo$1 extends C30431dv implements AnonymousClass1OS {
    ...
    public ConversationsSuggestedContactsViewModel$updateSuggestionPicOrInfo$1(ConversationsSuggestedContactsViewModel conversationsSuggestedContactsViewModel, AnonymousClass1BI r3, C30391dr r4) {
        super(2, r4);
        ...
        if (this.label == 0) {
            ...
            while (true) {
                if (i >= size) {
                    ...
                    AnonymousClass1E7 A0E = this.this$0.A07.A0E(this.$jid);
                    if (A0E != null) {
                        ConversationsSuggestedContactsViewModel conversationsSuggestedContactsViewModel = this.this$0;
                        ((AnonymousClass4FM) conversationsSuggestedContactsViewModel.A03.get(i)).A00 = A0E;
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return ((ConversationsSuggestedContactsViewModel$updateSuggestionPicOrInfo$1) C30411dt.A04(obj2, obj, this)).invokeSuspend(C27621Wu.A00);
    }
}
