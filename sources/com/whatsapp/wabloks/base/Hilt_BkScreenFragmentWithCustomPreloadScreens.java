...
public abstract class Hilt_BkScreenFragmentWithCustomPreloadScreens extends BkFragment implements AnonymousClass009 {
    ...
    public void A1p(android.app.Activity r4) {
        ...
        L_0x000f:
            ...
            X.C36241nZ.A26(r1, r0)
        L_0x0029:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.whatsapp.wabloks.base.Hilt_BkScreenFragmentWithCustomPreloadScreens.A1p(android.app.Activity):void");
    }
    ...
    public void A1x(Context context) {
        ...
        if (!this.A00) {
            this.A00 = true;
            C36241nZ.A26((C36241nZ) ((C008903z) generatedComponent()), (BkScreenFragmentWithCustomPreloadScreens) this);
        }
    }
