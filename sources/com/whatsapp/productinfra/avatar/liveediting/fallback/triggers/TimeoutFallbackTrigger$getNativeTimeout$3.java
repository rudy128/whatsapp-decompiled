...
public final class TimeoutFallbackTrigger$getNativeTimeout$3 extends C30431dv implements AnonymousClass1OS {
    public int label;

    public TimeoutFallbackTrigger$getNativeTimeout$3(C30391dr r2) {
        super(2, r2);
    }

    public final C30391dr create(Object obj, C30391dr r3) {
        return new TimeoutFallbackTrigger$getNativeTimeout$3(r3);
    }
