...
public final class AvatarPrefetchController$initialize$4 extends C30431dv implements AnonymousClass1OS {
    public int label;

    public AvatarPrefetchController$initialize$4(C30391dr r2) {
        super(2, r2);
    }

    public final C30391dr create(Object obj, C30391dr r3) {
        return new AvatarPrefetchController$initialize$4(r3);
    }
