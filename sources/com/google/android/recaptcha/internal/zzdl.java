...
public final class zzdl implements zzdd {
    public static final zzdl zza = new Object();
    ...
    public final void zza(int i, zzcj zzcj, zzpq... zzpqArr) {
        ...
        if (length >= 2) {
            ...
            if (method != null) {
                ...
                Object[] zzh = zzcj.zze.zzh(C200410p.A0Q(zzpqArr).subList(2, length));
                try {
                    zzcj.zze.zzf(i, method.invoke(A0b, Arrays.copyOf(zzh, zzh.length)));
                } catch (Exception e) {
