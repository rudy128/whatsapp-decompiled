...
public abstract class b {
    ...
    public static String a(int i) {
        ...
        return BEA.A0l(" (https://developer.android.com/google/play/integrity/reference/com/google/android/play/core/integrity/model/StandardIntegrityErrorCode.html#", C17880vN.A0s(valueOf, map2), AnonymousClass000.A11(C17880vN.A0s(valueOf, map)));
    }
    ...
    static {
        ...
        A11.put(-17, "The provided request hash is too long. The request hash length must be less than 500 bytes.\nRetry with a shorter request hash.");
        A11.put(-18, "There is a transient error on the calling device.\nRetry with an exponential backoff.\n");
        A11.put(-19, "The StandardIntegrityTokenProvider is invalid (e.g. it is outdated).\nRequest a new integrity token provider by calling StandardIntegrityManager#prepareIntegrityToken.");
        Integer A0Y = BE7.A0Y();
        ...
        A112.put(-17, "REQUEST_HASH_TOO_LONG");
        A112.put(-12, "GOOGLE_SERVER_UNAVAILABLE");
        A112.put(-18, "CLIENT_TRANSIENT_ERROR");
        A112.put(-19, "INTEGRITY_TOKEN_PROVIDER_INVALID");
