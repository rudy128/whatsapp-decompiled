...
public final class CredentialProviderBeginSignInController extends CredentialProviderController {
    ...
    public final CredentialProviderBeginSignInController$resultReceiver$1 resultReceiver = new CredentialProviderBeginSignInController$resultReceiver$1(this, C17890vO.A0D());
    ...
    private final BKC createGoogleIdCredential(C23142Bbv bbv) {
        String str = null;
        String str2 = null;
        String str3 = null;
        Uri uri = null;
    ...
    public C23140Bbt convertRequestToPlayServices(C24740CIc cIc) {
        C18070vi.A0d(cIc, 0);
        return BeginSignInControllerUtility.Companion.constructBeginSignInRequest$credentials_play_services_auth_release(cIc, this.context);
    }
    ...
    public C24741CId convertResponseToCredentialManager(C23142Bbv bbv) {
        ...
        if (str != null) {
            ...
            A0D.putString("androidx.credentials.BUNDLE_KEY_ID", str2);
            A0D.putString("androidx.credentials.BUNDLE_KEY_PASSWORD", str);
            cIb = new C24739CIb(A0D);
            if (str.length() <= 0) {
                throw AnonymousClass000.A0k("password should not be empty");
            }
        } else if (bbv.A07 != null) {
            cIb = createGoogleIdCredential(bbv);
        } else if (bbv.A01 != null) {
            String assertPasskeyResponse = PublicKeyCredentialControllerUtility.Companion.toAssertPasskeyResponse(bbv);
            Bundle A0D2 = C17880vN.A0D();
            A0D2.putString("androidx.credentials.BUNDLE_KEY_AUTHENTICATION_RESPONSE_JSON", assertPasskeyResponse);
            cIb = new BK9(assertPasskeyResponse, A0D2);
        } else {
            Log.w(TAG, "Credential returned but no google Id or password or passkey found");
            throw new BKL("When attempting to convert get response, null credential found");
        }
        return new C24741CId(cIb);
    }
    ...
    public final void handleResponse$credentials_play_services_auth_release(int i, int i2, Intent intent) {
        ...
        if (!CredentialProviderController.Companion.maybeReportErrorResultCodeGet(i2, CredentialProviderBeginSignInController$handleResponse$1.INSTANCE, new CredentialProviderBeginSignInController$handleResponse$2(this), this.cancellationSignal)) {
            try {
                ...
                CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderBeginSignInController$handleResponse$3(this, convertResponseToCredentialManager(new BZ5(context2, (C26890DHx) new Object()).A06(intent))));
                ...
                if (i4 == 16) {
                    ...
                    CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderBeginSignInController$handleResponse$4(this, A00));
                }
                A00.element = bkk;
                CredentialProviderController.cancelOrCallbackExceptionOrResult(this.cancellationSignal, new CredentialProviderBeginSignInController$handleResponse$4(this, A00));
            } catch (C24398C1t e2) {
                ...
                cancellationSignal2 = this.cancellationSignal;
                r1 = new CredentialProviderBeginSignInController$handleResponse$6(this, bkl);
                CredentialProviderController.cancelOrCallbackExceptionOrResult(cancellationSignal2, r1);
            }
        }
    }
    ...
    public void invokePlayServices(C24740CIc cIc, E7A e7a, Executor executor2, CancellationSignal cancellationSignal2) {
        ...
        if (!CredentialProviderPlayServicesImpl.Companion.cancellationReviewer$credentials_play_services_auth_release(cancellationSignal2)) {
            C23140Bbt convertRequestToPlayServices = convertRequestToPlayServices(cIc);
