...
public final class HiddenActivity$handleGetSignInIntent$1$1 extends AnonymousClass11G implements C22821Di {
    ...
    public final void invoke(PendingIntent pendingIntent) {
        try {
            ...
            hiddenActivity2.setupFailure(resultReceiver, CredentialProviderBaseController.GET_UNKNOWN, C17900vP.A0C("During get sign-in intent, one tap ui intent sender failure: ", AnonymousClass000.A10(), e));
        }
    }
