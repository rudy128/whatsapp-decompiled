...
public final class HoverableNode$onPointerEvent$2 extends C30431dv implements AnonymousClass1OS {
    public int label;
    public final /* synthetic */ HoverableNode this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public HoverableNode$onPointerEvent$2(HoverableNode hoverableNode, C30391dr r3) {
        super(2, r3);
    ...
    public final Object invoke(C30391dr r3, AnonymousClass1OX r4) {
        return ((HoverableNode$onPointerEvent$2) create(r4, r3)).invokeSuspend(C27621Wu.A00);
    }
