...
public final class LazyListState$updateScrollDeltaForPostLookahead$2$2 extends C30431dv implements AnonymousClass1OS {
    public int label;
    public final /* synthetic */ LazyListState this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public LazyListState$updateScrollDeltaForPostLookahead$2$2(LazyListState lazyListState, C30391dr r3) {
        super(2, r3);
    ...
    public final Object invoke(C30391dr r3, AnonymousClass1OX r4) {
        return ((LazyListState$updateScrollDeltaForPostLookahead$2$2) create(r4, r3)).invokeSuspend(C27621Wu.A00);
    }

    public final C30391dr create(Object obj, C30391dr r4) {
        return new LazyListState$updateScrollDeltaForPostLookahead$2$2(this.this$0, r4);
    }
