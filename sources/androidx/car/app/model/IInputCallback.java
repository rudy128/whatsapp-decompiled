    ...
    public abstract class Stub extends Binder implements IInputCallback {
        ...
        public class Proxy implements IInputCallback {
            ...
            public void onInputSubmitted(String str, IOnDoneCallback iOnDoneCallback) {
                ...
                try {
                    AnonymousClass000.A19(iOnDoneCallback, obtain, IInputCallback.DESCRIPTOR, str);
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i >= 1) {
                if (i <= 16777215) {
                    ...
                    if (i == 2) {
                        onInputTextChanged(parcel.readString(), AnonymousClass000.A0a(parcel));
                        return true;
                    } else if (i == 3) {
                        onInputSubmitted(parcel.readString(), AnonymousClass000.A0a(parcel));
                        return true;
                    }
