        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) {
            if (i >= 1) {
                if (i <= 16777215) {
                    ...
                    if (i == 2) {
                        getTemplate(AnonymousClass000.A0a(parcel));
                    } else if (i == 3) {
                        onBackPressed(AnonymousClass000.A0a(parcel));
                    } else if (i == 4) {
                        startLocationUpdates(AnonymousClass000.A0a(parcel));
                    } else if (i == 5) {
                        stopLocationUpdates(AnonymousClass000.A0a(parcel));
                    }
                    throw null;
