...
public final class EditorInfoCompat {
    ...
    public static CharSequence getInitialTextAfterCursor(EditorInfo editorInfo, int i, int i2) {
        ...
        int A09 = BE6.A09(charSequence.length(), i3, i) + i3;
        if ((i2 & 1) != 0) {
            return charSequence.subSequence(i3, A09);
        }
        return TextUtils.substring(charSequence, i3, A09);
    }
    ...
    public static void setSurroundingText(EditorInfo editorInfo, CharSequence charSequence, int i, int i2) {
        ...
        if (editorInfo.extras == null) {
            editorInfo.extras = C17880vN.A0D();
        }
    ...
    public static void trimLongSurroundingText(EditorInfo editorInfo, CharSequence charSequence, int i, int i2) {
        ...
        int i5 = 2048 - i4;
        int A09 = BE6.A09(i5, Math.min(i, (int) (((double) i5) * 0.8d)), charSequence.length() - i2);
        int A092 = BE6.A09(i5, A09, i);
        int i6 = i - A092;
        if (Character.isLowSurrogate(charSequence.charAt(i6))) {
            i6++;
            A092--;
        }
        if (Character.isHighSurrogate(charSequence.charAt((i2 + A09) - 1))) {
            A09--;
        }
        int i7 = A092 + i4;
        int i8 = i7 + A09;
        if (i4 != i3) {
            subSequence = TextUtils.concat(new CharSequence[]{charSequence.subSequence(i6, i6 + A092), charSequence.subSequence(i2, A09 + i2)});
        } else {
            subSequence = charSequence.subSequence(i6, i8 + i6);
        }
        setSurroundingText(editorInfo, subSequence, A092, i7);
    }

    public static void setInitialSurroundingSubText(EditorInfo editorInfo, CharSequence charSequence, int i) {
        C28111Yx.A02(charSequence);
        if (Build.VERSION.SDK_INT >= 30) {
        ...
        if (i < 0 || i5 < 0 || i6 > length || isPasswordInputType(editorInfo.inputType)) {
