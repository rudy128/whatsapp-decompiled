...
public class TransformC14NExclusive extends TransformSpi {
    ...
    public XMLSignatureInput a(XMLSignatureInput xMLSignatureInput, OutputStream outputStream, Transform transform) {
        ...
        try {
            ...
            Canonicalizer20010315Excl canonicalizer20010315Excl = new Canonicalizer20010315Excl(false);
            if (outputStream != null) {
                canonicalizer20010315Excl.n = outputStream;
            }
            XMLSignatureInput xMLSignatureInput2 = new XMLSignatureInput(canonicalizer20010315Excl.a(xMLSignatureInput, str));
            if (outputStream != null) {
