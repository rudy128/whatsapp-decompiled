        ...
        try {
            if (xMLSignatureInput.g()) {
                ...
                if (outputStream == null) {
                    return new XMLSignatureInput(Base64.a(A0s.toString()));
                }
                Base64.a(A0s.toString(), outputStream);
                ...
                try {
                    ...
                    a(documentElement, A0s2);
                    return new XMLSignatureInput(Base64.a(A0s2.toString()));
