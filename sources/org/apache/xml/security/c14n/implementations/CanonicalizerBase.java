...
public abstract class CanonicalizerBase extends CanonicalizerSpi {
    ...
    public static final AttrCompare g = new Object();
    ...
    /* JADX WARNING: type inference failed for: r0v14, types: [org.apache.xml.security.c14n.helper.AttrCompare, java.lang.Object] */
    static {
        try {
            ...
            A0s.append("Unable to create nullNode");
            A0s.append(e2);
            throw BE8.A0f(A0s);
        }
    }
            ...
            while (true) {
                    ...
                    case 1:
                        ...
                        if (a == i2) {
                            ...
                            if (a == 1) {
                                ...
                                UtfHelpper.a(str, outputStream, A11);
                            } else {
                                z = false;
                            ...
                            if (b2 != null) {
                                while (b2.hasNext()) {
                                    ...
                                    a(node4.getNodeName(), node4.getNodeValue(), outputStream, (Map) A11);
                                }
                            }
                            if (z) {
                ...
                while (node == null) {
                    if (element != null) {
                        if (c(element)) {
                            outputStream.write(t);
                            UtfHelpper.a(element.getTagName(), outputStream, A11);
                            outputStream.write(62);
                            nameSpaceSymbTable.b();
                        } else {
                            nameSpaceSymbTable.d();
                ...
                switch (node.getNodeType()) {
                    case 1:
                        ...
                        if (node != node3) {
                            ...
                            UtfHelpper.a(tagName, outputStream, A11);
                            Iterator a = a(element2, nameSpaceSymbTable);
                            if (a != null) {
                                while (a.hasNext()) {
                                    Node node5 = (Node) a.next();
                                    a(node5.getNodeName(), node5.getNodeValue(), outputStream, (Map) A11);
                                }
                            }
                            outputStream.write(62);
                            Node firstChild = node.getFirstChild();
