    ...
    public Iterator a(Element element, NameSpaceSymbTable nameSpaceSymbTable) {
        ...
        while (true) {
            ...
            if (i2 < i) {
                ...
                while (it.hasNext()) {
                    Attr a = nameSpaceSymbTable.a(C17880vN.A0v(it));
                    if (a != null) {
                        sortedSet.add(a);
                    }
                }
            ...
            if (BE8.A1a("http://www.w3.org/2000/xmlns/", attr)) {
                ...
                if (!z || c(attr) || "xmlns".equals(localName)) {
                    ...
                    if (!z && c(attr) && this.b.contains(localName)) {
                        ...
                        if (b2 != null) {
                            ...
                            if (C14nHelper.a(attr)) {
                                ...
                                AnonymousClass8BS.A1B(element.getTagName(), localName, objArr);
                    ...
                    if (nameSpaceSymbTable.a(localName, nodeValue, attr) && (!C14nHelper.b(nodeValue))) {
                        ...
                        AnonymousClass8BS.A1B(element.getTagName(), localName, objArr2);
