...
public class I18n {
    ...
    public static String a(String str, Exception exc) {
        try {
            ...
            StringBuffer A0g = BEB.A0g(str);
            A0g.append("\". Original Exception was a ");
            A0g.append(C17890vO.A0U(exc));
            A0g.append(" and message ");
            return BE7.A0n(exc.getMessage(), A0g);
        }
    }
