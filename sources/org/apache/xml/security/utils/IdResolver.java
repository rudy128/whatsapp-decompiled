...
public class IdResolver {
    ...
    static {
        ...
        List A15 = AnonymousClass8BR.A15("urn:oasis:names:tc:SAML:1.0:protocol", strArr, 5);
        d = A15;
        e = A15.size();
    }
    ...
    public static Element b(Document document, String str) {
        if (b.isDebugEnabled()) {
            BEA.A1O("getElementByIdUsingDOM() Search for ID ", str, BE6.A0s(), b);
        }
    ...
    public static Element c(Document document, String str) {
        ...
        Reference reference;
        if (b.isDebugEnabled()) {
            BEA.A1O("getElementByIdType() Search for ID ", str, BE6.A0s(), b);
        }
        synchronized (c) {
    ...
    public static void a(Element element, String str) {
        ...
        weakHashMap.put(str, AnonymousClass3MW.A0z(element));
    }
}
