...
public class Base64 {
    ...
    public static final byte[] b(byte[] r14, int r15) {
        ...
        L_0x0013:
            ...
            int r1 = r1 << 2
            int r0 = r10 >> 4
            X.BE6.A1N(r5, r1, r0, r11)
            int r7 = r8 + 1
            r0 = r10 & 15
            int r1 = r0 << 4
            int r0 = r6 >> 2
            r0 = r0 & 15
            X.BE6.A1N(r5, r1, r0, r8)
            int r0 = r6 << 6
            r0 = r0 | r9
            byte r0 = (byte) r0
        L_0x0059:
        ...
        L_0x005c:
            ...
            int r1 = r6 << 2
            int r0 = r11 >> 4
            X.BE6.A1N(r5, r1, r0, r10)
            int r6 = r7 + 1
            r0 = r11 & 15
            int r1 = r0 << 4
            int r0 = r9 >> 2
            r0 = r0 & 15
            X.BE6.A1N(r5, r1, r0, r7)
            int r10 = r6 + 1
            int r0 = r9 << 6
            X.BE6.A1N(r5, r8, r0, r6)
            int r13 = r13 + -1
            goto L_0x005c
        L_0x009e:
            r0 = 61
            boolean r5 = X.AnonymousClass000.A1T(r5, r0)
    ...
    public static final void a(InputStream inputStream, OutputStream outputStream) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                byte b3 = (byte) read;
                if (!a(b3)) {
                    boolean A1T = AnonymousClass000.A1T(b3, 61);
                    int i4 = i3 + 1;
                    bArr[i3] = b3;
                    if (A1T) {
                        if (i4 == 3) {
            ...
            BE6.A1F(outputStream, b4 << 2, b5 >> 4);
            BE6.A1F(outputStream, (b5 & 15) << 4, (b6 >> 2) & 15);
            BE6.A1F(outputStream, b7, b6 << 6);
        }
        byte b8 = bArr[0];
        byte b9 = bArr[1];
        byte b10 = bArr[2];
        ...
        byte b15 = bArr3[b11];
        if (b14 == -1 || b15 == -1) {
            boolean A1T2 = AnonymousClass000.A1T(b10, 61);
            boolean A1T3 = AnonymousClass000.A1T(b11, 61);
            if (A1T2) {
                if (A1T3) {
                    if ((b13 & 15) == 0) {
                        i = b12 << 2;
            ...
            if (A1T3) {
                if ((b14 & 3) == 0) {
                    BE6.A1F(outputStream, b12 << 2, b13 >> 4);
                    i = (b13 & 15) << 4;
                    i2 = (b14 >> 2) & 15;
                } else {
                    throw new Base64DecodingException("decoding.general");
            ...
            BE6.A1F(outputStream, b12 << 2, b13 >> 4);
            BE6.A1F(outputStream, (b13 & 15) << 4, (b14 >> 2) & 15);
            b2 = (b14 << 6) | b15;
        }
    ...
    public static final boolean b(byte b2) {
        return AnonymousClass000.A1T(b2, 61);
    }
}
